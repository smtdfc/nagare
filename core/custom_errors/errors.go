...
var (
	...
	ErrUninstallPluginFailed          = NewNagareCoreError("UNINSTALL_PLUGIN_FAILED", "Failed to uninstall plugin")
	ErrPluginNotActive                = NewNagareCoreError("PLUGIN_NOT_ACTIVE", "Plugin is not active")
	ErrPluginAlreadyActive            = NewNagareCoreError("PLUGIN_ALREADY_ACTIVE", "Plugin is already active")
	...
	ErrCreateTaskFailed               = NewNagareCoreError("CREATE_TASK_FAILED", "Failed to create task")
