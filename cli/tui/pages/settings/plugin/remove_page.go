	...
	case tea.KeyMsg:
		...
		case "esc", "q":
			return m, func() tea.Msg {
				return router.ChangePageMsg{Target: "settings:plugin", Refresh: true}
			}
		case "ctrl+c":
			return m, tea.Quit
		case "enter":
...
func (m *RemovePage) View() tea.View {
	...
	title := lipgloss.NewStyle().Bold(true).Foreground(lipgloss.Color("160")).Render("Select Plugin to Remove")
